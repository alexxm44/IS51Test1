...
"""
The program is trying to determine which payment option is better. Meaning which option ends up giving you the more money
First option is 100 dollars a day for 10 days.
The second option is 1 dollar a day with it being doubled each day for 10 days.
There will two functions to calculate the pay rate. 
